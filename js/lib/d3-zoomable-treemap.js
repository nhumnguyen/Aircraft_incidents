        ...
        rect
            ...
            .attr("fill", function (d) {
                ...
                if (d.depth === 3) {
                    ...
                    if (d.depth === 4) {
                                    var parentColor = color_scale(d.parent.parent.parent.data.label);
                                    var max = d3.max(d.parent.children, function(child) {
                                        return child.value;
                                    });
                                    var childColor = d3.scaleLinear()
                      ...
                      if (d.depth === 5) {
                                                         var parentColor = color_scale(d.parent.parent.parent.parent.data.label);
                                                         var max = d3.max(d.parent.children, function(child) {
                       ...
                       if (d.depth === 6) {
                                                                               var parentColor = color_scale(d.parent.parent.parent.parent.parent.data.label);
                                                                               var max = d3.max(d.parent.children, function(child) {
                                                                                   return child.data.size;
                                                                               });
                                                                               var childColor = d3.scaleLinear()
